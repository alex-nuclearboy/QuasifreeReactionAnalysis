...
protected:
    ...
    TH2F    *hEkin_vs_Theta_p_lab_MC,*hEkin_vs_Theta_p_cm_MC;
    ...
    TH1F    *hOpeningAngle_p_d_lab_MC,*hOpeningAngle_p_d_cm_MC;

    TH2F    *hTheta_FDvsTheta_CD_lab_MC,*hTheta_FDvsTheta_CD_p_lab_MC,*hTheta_FDvsTheta_CD_d_lab_MC;
    TH2F    *hTheta_p_vs_Theta_d_lab_MC,*hTheta_p_vs_Theta_d_cm_MC;
    ...
    TH1F    *hQ[5][1];
    TH1F    *hQ_wght_bilin[5][1],*hQ_wght_prx[5][1],*hQ_wght_lin[5][1],*hQ_wght_sq[5][1];
