...
//Selection cuts for the analysis of the simulation results of the elastic pd -> pd scattering reaction
...
//////////////////////////////////////////KINEMATICS////////////////////////////////////////////
    ...
    if (gWasa->IsAnalysisMode(Wasa::kMCRaw)||
        ...
        Double_t Ekin_p_lab_MC;
        Double_t E_p_lab_MC;
        Double_t p_p_lab_MC;
        Double_t Theta_p_lab_MC;
        Double_t Phi_p_lab_MC;
        ...
        ////Angles////
        Double_t OpeningAngle_p_d_lab_MC = (vec_p_MC.Angle(vec_d_MC))*TMath::RadToDeg();    //angle between proton & deuteron

        Double_t Delta_Phi_lab_MC = (Phi_p_lab_MC - Phi_d_lab_MC)*TMath::RadToDeg();        //coplanarity definition

        hOpeningAngle_p_d_lab_MC->Fill(OpeningAngle_p_d_lab_MC);
        hDelta_Phi_lab_MC->Fill(Delta_Phi_lab_MC);

        //theta for protons
        hTheta_p_vs_Theta_d_lab_MC->Fill(Theta_p_lab_MC*TMath::RadToDeg(),Theta_d_lab_MC*TMath::RadToDeg());

        if ((Theta_p_lab_MC >= 0.052) && (Theta_p_lab_MC <= 0.314) && (Theta_d_lab_MC >= 0.349) && (Theta_d_lab_MC <= 2.950)) {
            hTheta_FDvsTheta_CD_lab_MC->Fill(Theta_p_lab_MC*TMath::RadToDeg(), Theta_d_lab_MC*TMath::RadToDeg());
            hTheta_FDvsTheta_CD_p_lab_MC->Fill(Theta_p_lab_MC*TMath::RadToDeg(), Theta_d_lab_MC*TMath::RadToDeg());
        }

        if ((Theta_d_lab_MC >= 0.052) && (Theta_d_lab_MC <= 0.314) && (Theta_p_lab_MC >= 0.349) && (Theta_p_lab_MC <= 2.950)) {
            hTheta_FDvsTheta_CD_lab_MC->Fill(Theta_d_lab_MC*TMath::RadToDeg(), Theta_p_lab_MC*TMath::RadToDeg());
            hTheta_FDvsTheta_CD_d_lab_MC->Fill(Theta_d_lab_MC*TMath::RadToDeg(), Theta_p_lab_MC*TMath::RadToDeg());
        }
        ...
        TVector3 vec_beam_MC = vec_d_MC + vec_p_MC;
...
////////////////////////////////////////////CM FRAME////////////////////////////////////////////
        ...
        Double_t p_p_cm_MC;
        Double_t E_p_cm_MC;
        Double_t Ekin_p_cm_MC;
        Double_t Theta_p_cm_MC;
        Double_t Phi_p_cm_MC;
        ...
        vec_p_cm_MC = P_p_MC.Vect();
        p_p_cm_MC = vec_p_cm_MC.Mag();
        //E_p_cm_MC = TMath::Sqrt(p_p_cm_MC*p_p_cm_MC + m_p*m_p);
        E_p_cm_MC = P_p_MC.E();
        Ekin_p_cm_MC = E_p_cm_MC - m_p;
        Theta_p_cm_MC = P_p_MC.Theta();
        Phi_p_cm_MC = P_p_MC.Phi();
        ...
        ////
        Double_t OpeningAngle_p_d_cm_MC = (vec_p_cm_MC.Angle(vec_d_cm_MC))*TMath::RadToDeg();   //angle between protons in CM [deg]

        Double_t Delta_Phi_cm_MC = (Phi_p_cm_MC - Phi_d_cm_MC)*TMath::RadToDeg();  //coplanarity

        hOpeningAngle_p_d_cm_MC->Fill(OpeningAngle_p_d_cm_MC);
        hDelta_Phi_cm_MC->Fill(Delta_Phi_cm_MC);

        hTheta_p_vs_Theta_d_cm_MC->Fill(Theta_p_cm_MC*TMath::RadToDeg(),Theta_d_cm_MC*TMath::RadToDeg());
...
//////////////////////////////////////////LEVELS 1-2////////////////////////////////////////////
        ...
        //cut on proton momentum distribution in CD (0,0.75) [GeV/c]//
        lev[4][0] = (lev[3][0] && (MomCD_lab <= 0.75));
...
////////////////////////////////////TRUE EVENTS (MONTE CARLO)///////////////////////////////////
    ...
    hEkin_d_cm_MC = new TH1F("hEkin_d_cm_MC","",500,0.16,0.22);
    ...
    hE_d_cm_MC = new TH1F("hE_d_cm_MC","",500,2.0,2.14);
    ...
    hp_d_cm_MC = new TH1F("hp_d_cm_MC","",500,0.8,0.92);
    ...
    hEkin_vs_Theta_d_cm_MC = new TH2F("hEkin_vs_Theta_d_cm_MC","",500,0.16,0.22,500,0.,180.);
    ...
    //proton//
    hEkin_p_lab_MC = new TH1F("hEkin_p_lab_MC","",500,0.,1.);
    hEkin_p_lab_MC->GetXaxis()->SetTitle("E^{lab}_{kin} [GeV]");
    hEkin_p_lab_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hEkin_p_lab_MC,h_mc);

    hEkin_p_cm_MC = new TH1F("hEkin_p_cm_MC","",500,0.29,0.38);
    hEkin_p_cm_MC->GetXaxis()->SetTitle("E^{cm}_{kin} [GeV]");
    hEkin_p_cm_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hEkin_p_cm_MC,h_mc);

    hE_p_lab_MC = new TH1F("hE_p_lab_MC","",500,0.9,2.);
    hE_p_lab_MC->GetXaxis()->SetTitle("E^{lab} [GeV]");
    hE_p_lab_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hE_p_lab_MC,h_mc);

    hE_p_cm_MC = new TH1F("hE_p_cm_MC","",500,1.22,1.33);
    hE_p_cm_MC->GetXaxis()->SetTitle("E^{cm} [GeV]");
    hE_p_cm_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hE_p_cm_MC,h_mc);

    hp_p_lab_MC = new TH1F("hp_p_lab_MC","",500,0.,2.);
    hp_p_lab_MC->GetXaxis()->SetTitle("p^{lab} [GeV/c]");
    hp_p_lab_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hp_p_lab_MC,h_mc);

    hp_p_cm_MC = new TH1F("hp_p_cm_MC","",500,0.8,0.92);
    hp_p_cm_MC->GetXaxis()->SetTitle("p^{cm} [GeV/c]");
    hp_p_cm_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hp_p_cm_MC,h_mc);

    hTheta_p_lab_MC = new TH1F("hTheta_p_lab_MC","",360,0.,180.);
    hTheta_p_lab_MC->GetXaxis()->SetTitle("#theta^{lab} [deg]");
    hTheta_p_lab_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hTheta_p_lab_MC,h_mc);

    hTheta_p_cm_MC = new TH1F("hTheta_p_cm_MC","",360,0.,180.);
    hTheta_p_cm_MC->GetXaxis()->SetTitle("#theta^{cm} [deg]");
    hTheta_p_cm_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hTheta_p_cm_MC,h_mc);

    hPhi_p_lab_MC = new TH1F("hPhi_p_lab_MC","",360,0.,360.);
    hPhi_p_lab_MC->GetXaxis()->SetTitle("#phi^{lab} [deg]");
    hPhi_p_lab_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hPhi_p_lab_MC,h_mc);

    hPhi_p_cm_MC = new TH1F("hPhi_p_cm_MC","",360,-180.,180.);
    hPhi_p_cm_MC->GetXaxis()->SetTitle("#phi^{cm} [deg]");
    hPhi_p_cm_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hPhi_p_cm_MC,h_mc);

    hEkin_vs_Theta_p_lab_MC = new TH2F("hEkin_vs_Theta_p_lab_MC","",500,0.,1.,500,0.,180.);
    hEkin_vs_Theta_p_lab_MC->GetXaxis()->SetTitle("E^{lab}_{kin} [GeV]");
    hEkin_vs_Theta_p_lab_MC->GetYaxis()->SetTitle("#theta^{lab} [deg]");
    gHistoManager->Add(hEkin_vs_Theta_p_lab_MC,h_mc);

    hEkin_vs_Theta_p_cm_MC = new TH2F("hEkin_vs_Theta_p_cm_MC","",500,0.29,0.38,500,0.,180.);
    hEkin_vs_Theta_p_cm_MC->GetXaxis()->SetTitle("E^{cm}_{kin} [GeV]");
    hEkin_vs_Theta_p_cm_MC->GetYaxis()->SetTitle("#theta^{cm} [deg]");
    gHistoManager->Add(hEkin_vs_Theta_p_cm_MC,h_mc);

    ////
    hOpeningAngle_p_d_lab_MC=new TH1F("hOpeningAngle_p_d_lab_MC","",360,0.,180.);
    hOpeningAngle_p_d_lab_MC->GetXaxis()->SetTitle("#theta^{lab}_{p,d} [deg]");
    hOpeningAngle_p_d_lab_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hOpeningAngle_p_d_lab_MC,h_mc);

    hOpeningAngle_p_d_cm_MC=new TH1F("hOpeningAngle_p_d_cm_MC","",200,0.,200.);
    hOpeningAngle_p_d_cm_MC->GetXaxis()->SetTitle("#theta^{cm}_{p,d} [deg]");
    hOpeningAngle_p_d_cm_MC->GetYaxis()->SetTitle("counts");
    gHistoManager->Add(hOpeningAngle_p_d_cm_MC,h_mc);
    ...
    hTheta_FDvsTheta_CD_d_lab_MC = new TH2F("hTheta_FDvsTheta_CD_d_lab_MC","",540,0.,20.,540,0.,180.);
    hTheta_FDvsTheta_CD_d_lab_MC->GetXaxis()->SetTitle("#theta^{lab}_{FD} [deg]");
    hTheta_FDvsTheta_CD_d_lab_MC->GetYaxis()->SetTitle("#theta^{lab}_{CD} [deg]");
    gHistoManager->Add(hTheta_FDvsTheta_CD_d_lab_MC,h_mc);

    hTheta_FDvsTheta_CD_p_lab_MC = new TH2F("hTheta_FDvsTheta_CD_p_lab_MC","",540,0.,20.,540,0.,180.);
    hTheta_FDvsTheta_CD_p_lab_MC->GetXaxis()->SetTitle("#theta^{lab}_{FD} [deg]");
    hTheta_FDvsTheta_CD_p_lab_MC->GetYaxis()->SetTitle("#theta^{lab}_{CD} [deg]");
    gHistoManager->Add(hTheta_FDvsTheta_CD_p_lab_MC,h_mc);

    hTheta_p_vs_Theta_d_lab_MC = new TH2F("hTheta_p_vs_Theta_d_lab_MC","",540,0.,180.,540,0.,180.);
    hTheta_p_vs_Theta_d_lab_MC->GetXaxis()->SetTitle("#theta^{lab}_{p} [deg]");
    hTheta_p_vs_Theta_d_lab_MC->GetYaxis()->SetTitle("#theta^{lab}_{d} [deg]");
    gHistoManager->Add(hTheta_p_vs_Theta_d_lab_MC,h_mc);

    hTheta_p_vs_Theta_d_cm_MC = new TH2F("hTheta_p_vs_Theta_d_cm_MC","",540,0.,180.,540,0.,180.);
    hTheta_p_vs_Theta_d_cm_MC->GetXaxis()->SetTitle("#theta^{cm}_{p} [deg]");
    hTheta_p_vs_Theta_d_cm_MC->GetYaxis()->SetTitle("#theta^{cm}_{d} [deg]");
    gHistoManager->Add(hTheta_p_vs_Theta_d_cm_MC,h_mc);
